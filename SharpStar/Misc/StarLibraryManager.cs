...
{
    //https://github.com/OrchardCMS/Brochard/blob/master/src/Orchard.DependencyInjection/OrchardLibraryManager.cs
    public interface IStarLibraryManager : ILibraryManager
    {
    ...
    public class StarLibraryManager : IStarLibraryManager
    {
        private readonly ILibraryManager _libraryManager;

        public StarLibraryManager(ILibraryManager libraryManager)
        {
